...
import com.epm.recipe.persistence.db_mysql.config.DbMysqlPersistenceConfiguration;
...
public class Bootstrap {
    ...
    public static void main(String[] args) throws Exception {
        ...
        context.register(DbMysqlPersistenceConfiguration.class, ServicesConfiguration.class, WebUiConfiguration.class, WebApiConfiguration.class);
