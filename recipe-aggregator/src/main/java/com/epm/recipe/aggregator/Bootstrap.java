...
import com.epm.recipe.persistence.jdbc.config.ConnectionPoolConfiguration;
...
public class Bootstrap {
    ...
    public static void main(String[] args) throws Exception {
        ...
        context.register(JdbcPersistenceConfiguration.class, ConnectionPoolConfiguration.class, ServicesConfiguration.class, WebUiConfiguration.class, WebApiConfiguration.class);
