...
import com.epm.recipe.service.impl.config.DefaultRecipeTransformerConfiguration;
...
public class Bootstrap {
    ...
    public static void main(String[] args) throws Exception {
        ...
        context.register(InMemoryPersistenceConfiguration.class, DefaultRecipeTransformerConfiguration.class, ServicesConfiguration.class, WebUiConfiguration.class);
