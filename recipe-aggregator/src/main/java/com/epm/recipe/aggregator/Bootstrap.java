...
import com.epm.recipe.persistence.config.PersistenceConfiguration;
...
public class Bootstrap {
    ...
    public static void main(String[] args) throws Exception {
        ...
        context.register(PersistenceConfiguration.class, ServicesConfiguration.class, WebUiConfiguration.class);//
