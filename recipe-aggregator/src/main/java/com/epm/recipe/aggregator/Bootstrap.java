...
import com.epm.recipe.aggregator.config.PropertySourcesConfiguration;
...
public class Bootstrap {
    ...
    public static void main(String[] args) throws Exception {
        ...
        context.register(JdbcPersistenceConfiguration.class, PropertySourcesConfiguration.class, ServicesConfiguration.class, WebUiConfiguration.class, WebApiConfiguration.class);
