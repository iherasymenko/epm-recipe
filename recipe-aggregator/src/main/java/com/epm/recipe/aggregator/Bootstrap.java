...
import com.epm.recipe.persistence.mariaDB.config.MariaDBPersistenceConfiguration;
...
public class Bootstrap {
    ...
    public static void main(String[] args) throws Exception {
        ...
        context.register(MariaDBPersistenceConfiguration.class, ServicesConfiguration.class, WebUiConfiguration.class);
