...
import com.epm.recipe.persistence.in_db.config.DBManagerConfiguration;
...
public class Bootstrap {
    ...
    public static void main(String[] args) throws Exception {
        ...
        context.register(DBManagerConfiguration.class, ServicesConfiguration.class, WebUiConfiguration.class);
